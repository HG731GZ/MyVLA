...
class SmolVLMVLAProcessor:
    ...
    language_max_length : int, default=96
    ...
    def __init__(
        ...
        if self.language_max_length < 1:
            raise ValueError("language_max_length must be positive")
    ...
    def from_pretrained(cls, pretrained_model_name_or_path: str, **kwargs):
        ...
        try:
            return cls(smolvlm_model_path=smolvlm_path, **kwargs)
    ...
    def encode_language(self, language_instruction: Union[str, List[str]]) -> Dict[str, torch.Tensor]:
        ...
        return {
            ...
            "text_attention_mask": inputs["attention_mask"].bool(),
        }
        ...
        **kwargs
        ...
        for sample_imgs in images:
            ...
            if V_exist > self.num_views:
                raise ValueError(
                    f"Received {V_exist} images, but num_views={self.num_views}."
                )
            if V_exist > 0:
